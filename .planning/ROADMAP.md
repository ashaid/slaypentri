...
Plans:
- [ ] 01-01-PLAN.md — Wave 0: Test scaffold (conftest, test_config, test_safety, test_image_pipeline, requirements.txt)
- [ ] 01-02-PLAN.md — Wave 1: painter.py foundation (AppState, config loader, Wayland detection, CLI, main skeleton)
- [ ] 01-03-PLAN.md — Wave 2: Image processing pipeline (load, grayscale, blur, Canny, contours, filter, simplify, normalize)
...
|-------|----------------|--------|-----------|
| 1. Image Pipeline and Safety | 0/4 | Not started | - |
